...
function docsDirs(a) {
  return ['specs', 'tasks/active', 'archive/tasks', 'reference/adr', 'workflow'].map((d) => `${a.docs}/${d}`);
}

const contextPath = (a) => `${a.docs}/reference/CONTEXT.md`;
const statusPath = (a) => `${a.docs}/workflow/status.md`;

// The earlier layout kept these at the docs root. update moves them.
function layoutMoves(a) {
  return [
