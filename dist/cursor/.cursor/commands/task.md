...
Input: the text the user typed after the command name
...
- Before starting, read `.cursor/commands/spec-writer.md` and follow its rules and restrictions for the whole of this command.
