...
Tasks are filed by spec, in `docs/tasks/<spec-slug>/`, and numbers are
...
- A spec slug: take the lowest-numbered file in `docs/tasks/<spec-slug>/`.
- Empty: if only one folder under `docs/tasks/` holds tasks, take its
